...
BoxCollision::BoxCollision(Plane faces[6])
{
...
const bool BoxCollision::SphereInside(const Vector3& spherePosition, const float& radius) const
{
...
const bool BoxCollision::SphereIntersecting(const Vector3& spherePosition, const float& radius) const
{
